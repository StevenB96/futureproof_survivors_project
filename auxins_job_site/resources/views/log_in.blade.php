...
@section('form')
    <form class="topLayer bg-light fontMedium fontMinimumSpace text-dark logInForm" id="loginForm" action="http://127.0.0.1:8000/user/log_in" method="get"> {{ csrf_field() }}
        ...
        <div class="form-group" style="grid-column-start: 1; grid-column-end: 3; grid-row-start: 3; grid-row-end: 4;">
            ...
            <input type="password" class="form-control fontMedium" id="password" name="password" required>
        </div>
